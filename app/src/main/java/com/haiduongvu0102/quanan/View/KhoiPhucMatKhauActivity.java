                ...
                if (kiemtraemail) {
                    ...
                    firebaseAuth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            {
                                Toast.makeText(KhoiPhucMatKhauActivity.this, getString(R.string.guithongbaokhoiphucthanhcong),Toast.LENGTH_SHORT).show();
                            }
                        }
                    });

                } else {
                    Toast.makeText(KhoiPhucMatKhauActivity.this, getString(R.string.emailkhonghople), Toast.LENGTH_SHORT).show();
                }
                break;
